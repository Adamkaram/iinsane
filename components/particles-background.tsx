            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full pointer-events-none">
                {children ? children : (
                    ...
                    >
                        ...
                        <Link target="_blank" rel="noopener noreferrer" href="https://kokonutui.com/" className="text-xl md:text-2xl font-medium bg-clip-text text-transparent bg-gradient-to-b from-black/90 to-black/50 dark:from-white/90 dark:to-white/50 flex items-center justify-center pointer-events-auto">
                            {subtitle}
                        </Link>
                    </motion.div>
                )}
